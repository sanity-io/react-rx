...
```ts
function component<Props>(observable: Observable<Props>): React.FunctionComponent<{}>
function component<Props>(component: Component<Props>): React.FunctionComponent<Props>
```
